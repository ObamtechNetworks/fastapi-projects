...
@router.get("/posts/{id}", response_model=schemas.PostResponse, status_code=status.HTTP_200_OK)
...
@router.patch("/posts/{id}", status_code=status.HTTP_200_OK, response_model=schemas.PostResponse)
