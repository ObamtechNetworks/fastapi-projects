...
def create_user(user: schemas.UserCreate, db: Session = Depends(get_db)):
    ...
    new_user = models.User(**user.model_dump(), password=hashed_password) # unpack the user object into a dictionary and pass it to the User model to create a new instance of the User model
    db.add(new_user)
    db.commit()
